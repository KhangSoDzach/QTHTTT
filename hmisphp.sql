...
CREATE TABLE `his_appointments` (
  ...
  `appointment_status` enum('Pending','Confirmed','Cancelled') NOT NULL DEFAULT 'Pending',
  `appointment_note` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

INSERT INTO `his_appointments` (`appointment_id`, `patient_id`, `doctor_id`, `appointment_date`, `appointment_time`, `appointment_status`, `appointment_note`) VALUES
(1, 8, 5, '2024-11-28', '12:56:00', 'Confirmed', NULL),
(9, 8, 12, '2024-12-05', '05:41:00', 'Confirmed', 'ko CÓ'),
(10, 8, 12, '2024-12-05', '05:41:00', 'Confirmed', 'ko CÓ');
...
(13, 'Khang', 'Dang', 'khang@mail.com', 'eeac057279e3628ff5c687e74e896c47aead36be', 'Laboratory', '62KNQ', NULL);
...
CREATE TABLE `his_pharmacists` (
  `phar_id` int(20) NOT NULL,
  `phar_fname` varchar(200) DEFAULT NULL,
  `phar_lname` varchar(200) DEFAULT NULL,
  `phar_email` varchar(200) DEFAULT NULL,
  `phar_pwd` varchar(200) DEFAULT NULL,
  `phar_dept` varchar(200) DEFAULT NULL,
  `phar_number` varchar(200) DEFAULT NULL,
  `phar_dpic` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

INSERT INTO `his_pharmacists` (`phar_id`, `phar_fname`, `phar_lname`, `phar_email`, `phar_pwd`, `phar_dept`, `phar_number`, `phar_dpic`) VALUES
(1, '', '', '', '55c3b5386c486feb662a0785f340938f518d547f', 'Pharmacy', 'P1234', 'Screenshot 2024-11-16 151438.png'),
(2, 'Jane', 'Smith', 'jane.smith@example.com', '55c3b5386c486feb662a0785f340938f518d547f', 'Pharmacy', 'P5678', 'jane_smith.jpg'),
(3, 'Peter', 'Jones', 'peter.jones@example.com', '55c3b5386c486feb662a0785f340938f518d547f', 'Lab', 'L9012', 'peter_jones.jpg');
...
INSERT INTO `his_surgery_managers` (`sm_id`, `sm_fname`, `sm_lname`, `sm_email`, `sm_pwd`, `sm_dpic`) VALUES
(1, 'Nguy?n', 'V?n A', 'nguyenvana@example.com', '4c7f5919e957f354d57243d37f223cf31e9e7181', 'nguyen_van_a.jpg'),
(2, 'Tr?n', 'Th? B', 'tranthib@mail.com', '4c7f5919e957f354d57243d37f223cf31e9e7181', 'tran_thi_b.jpg'),
(3, 'Lê', 'V?n C', 'levanc@example.com', '4c7f5919e957f354d57243d37f223cf31e9e7181', 'le_van_c.jpg');
...
CREATE TABLE `users` (
  ...
  `user_dpic` varchar(255) DEFAULT 'default.jpg',
  `user_rank` enum('standard','VIP') NOT NULL DEFAULT 'standard',
  `user_mobile` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `users` (`user_id`, `user_email`, `user_pwd`, `user_fname`, `user_lname`, `user_dpic`, `user_rank`, `user_mobile`) VALUES
(8, 'johndoe@example.com', '202cb962ac59075b964b07152d234b70', 'John', 'Doe', 'johndoe.jpg', 'standard', '0987654321');
...
ALTER TABLE `his_surgery_managers`
...
ALTER TABLE `his_surgery_managers`
  MODIFY `sm_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
nstraints for table `his_appointments`
--
ALTER TABLE `his_appointments`
  ADD CONSTRAINT `his_appointments_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `his_patients` (`pat_id`),
  ADD CONSTRAINT `his_appointments_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `his_docs` (`doc_id`);
COMMIT;