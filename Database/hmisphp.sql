...
-- Thêm dữ liệu cho bảng his_pharmacists, tương tự cấu trúc his_docs
INSERT INTO `his_pharmacists` (`phar_fname`, `phar_lname`, `phar_email`, `phar_pwd`, `phar_dept`, `phar_number`, `phar_dpic`) 
VALUES 
('John', 'Doe', 'john.doe@example.com', '55c3b5386c486feb662a0785f340938f518d547f', 'Pharmacy', 'P1234', 'john_doe.jpg'),
('Jane', 'Smith', 'jane.smith@example.com', '55c3b5386c486feb662a0785f340938f518d547f', 'Pharmacy', 'P5678', 'jane_smith.jpg'),
('Peter', 'Jones', 'peter.jones@example.com', '55c3b5386c486feb662a0785f340938f518d547f', 'Lab', 'L9012', 'peter_jones.jpg');
--
...
CREATE TABLE `his_appointments` (
  ...
  `appointment_date` date 1  NOT NULL,
  `appointment_time` time NOT NULL,
  PRIMARY KEY (`appointment_id`),
  FOREIGN KEY (`patient_id`) REFERENCES `his_patients` (`pat_id`),
  FOREIGN KEY (`doctor_id`) REFERENCES `his_docs` (`doc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
